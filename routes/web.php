...
use App\Http\Controllers\TentangBiologiController;
...
Route::get('/tentang-biologi', function () {
    return view('tentang-biologi');
});

Route::get('/tentang-biologi', [TentangBiologiController::class, 'index']);
