...
<head>
        <title>Biologi - Detail Dosen</title>
        <meta charset="utf-8">
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center p-3 border rounded shadow-sm">
                ...
                @if ($pimpinanStaff->id_google_scholar)
                    ...
                    @endphp
                    <a href="{{ $scholarUrl }}" target="_blank" class="btn btn-large btn-round-edge btn-box-shadow w-100" style="background-color: #388E3C; color: white;">Google Scholar</a>
                @else
