                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                ...
                                @endif
                                <a href="{{ route('detail-fasilitas', ['id' => $item->id]) }}" class="btn btn-large btn-round-edge btn-box-shadow" style="background-color: #388E3C; color: white;"><span class="bg-base-color"></span>Lihat Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                </div>
