...
<head>
        <title>Biologi - Detail Berita</title>
        <meta charset="utf-8">
    ...
    <body data-mobile-nav-style="full-screen-menu" data-mobile-nav-bg-color="">
        ...
        <header class="header-with-topbar">
            <div class="header-top-bar top-bar-dark cover-background" stystyle="background-color: #388E3C; padding-top: 10px; padding-bottom: 10px;">
